...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Birucoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"clonecointools.com", "128.199.248.160"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Birucoin is probably already running."), addrBind.ToString().c_str());
        else
